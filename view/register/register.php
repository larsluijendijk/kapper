<form class="form-horizontal" action="<?= URL ?>register/createUser" method="POST" style="margin-left:auto; margin-right:auto; width:200px;">
  <fieldset>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="postalcode" name="postalcode" placeholder="" class="input-xlarge" required>
      </div>
      ...
      <div class="controls">
        <input type="text" id="phonenumber" name="phonenumber" placeholder="" class="input-xlarge" required>
